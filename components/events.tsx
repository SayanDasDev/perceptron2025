...
const Events = () => {
  ...
  return (
    <>
      ...
      <div className="event h-screen w-screen flex items-center justify-center text-8xl bg-red-200">Event 10</div>
      <div className="event h-screen w-screen flex items-center justify-center text-8xl bg-cyan-200">Event 11</div>
      <div className="event h-screen w-screen flex items-center justify-center text-8xl bg-amber-200">Event 12</div>
